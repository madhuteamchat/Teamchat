		...
		api.perform(api
				...
				.post(new PrimaryChatlet()
						.setQuestionHtml("<h4>List of commands: </h4>"
								...
								+ "<hr/><b style=\"cursor: pointer;\" onclick=\"document.getElementById('post-message').value = 'logout';\">message:</b> To logout of the existing account")));
	}
				...
				api.perform(api
						...
						.post(new PrimaryChatlet()
								.setQuestionHtml("<h4 style=\"display:block;margin:0 auto;\">Login with Basecamp</h4>"
										...
										+ "https://launchpad.37signals.com/authorization/new?client_id=d48fa4605608e6bc3405232a71051aeb171eda35&redirect_uri=" + URLEncoder.encode(Universal.REDIRECT_URL, "UTF-8") +"&type=web_server\""
