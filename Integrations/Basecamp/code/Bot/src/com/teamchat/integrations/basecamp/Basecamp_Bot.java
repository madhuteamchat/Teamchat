...
public class Basecamp_Bot {
	...
	public Boolean isBasecampnotPresent(TeamchatAPI api) {
				...
				api.perform(api
						...
						.post(new PrimaryChatlet()
								.setQuestionHtml("<h4 style=\"display:block;margin:0 auto;\">Login with Basecamp</h4>"
										...
										+ "https://launchpad.37signals.com/authorization/new?client_id=d48fa4605608e6bc3405232a71051aeb171eda35&redirect_uri=http%3A%2F%2Fintegration.teamchat.com%3A8082%2FBasecamp_bot%2FRedirect_url&type=web_server\""
