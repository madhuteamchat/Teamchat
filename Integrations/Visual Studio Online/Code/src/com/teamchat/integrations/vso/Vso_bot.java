 ...
 *
 */
public class Vso_bot {
	// help commands
	@OnKeyword(value = "help")
	public void help(TeamchatAPI api) throws Exception {
		String url = "https://app.vssps.visualstudio.com/oauth2/authorize"
								+ "?client_id=99330BBC-9CF4-46D9-B814-2645F7DC6094"
								+ "&response_type=Assertion"
								+ "&state=state"
								+ "&scope="
								+ URLEncoder.encode(
								"vso.build_execute vso.chat_manage vso.code_manage vso.test_write vso.work_write", "UTF-8")
								+ "&redirect_uri="
								+ URLEncoder.encode(
								"https://e321c67f.ngrok.io/VisualStudioOnline_bot/Redirect_url", "UTF-8");
		api.perform(api
				.context()
				.currentRoom()
				.post(new PrimaryChatlet()
						.setQuestionHtml("<h4 style=\"display:block;margin:0 auto;\">Login with Visual Studio</h4>"
								+ "<hr/>"
								+ "<a class=\"login-button\" target=\"_blank\" href=\"" + url + "\""
								+ "style=\"display: block;box-sizing: border-box;transform: scale(0.5);width: 427px;margin: 0 auto;height: 125px;background-position: 50% 50%;background-size: 370px 83px;padding: 25px;background-repeat: no-repeat;"
								+ "background-image: url('http://thenextweb.com/wp-content/blogs.dir/1/files/2015/03/visual-studio-01.jpg');"+ "</a>")));
...
//		public Boolean isBasecampPresent(TeamchatAPI api) {
...
//							.currentRoom()
//							.post(new PrimaryChatlet()
//									.setQuestionHtml("<h4 style=\"display:block;margin:0 auto;\">Login with Basecamp</h4>"
//											+ "<hr/>"
//											+ "<a class=\"login-button\" target=\"_blank\" href=\""
//											+ "https://launchpad.37signals.com/authorization/new?client_id=d48fa4605608e6bc3405232a71051aeb171eda35&redirect_uri=http%3A%2F%2Finterns.teamchat.com%2FBasecamp_bot%2FRedirect_url&type=web_server\""
