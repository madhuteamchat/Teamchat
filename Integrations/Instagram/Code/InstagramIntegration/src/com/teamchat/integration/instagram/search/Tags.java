...
public class Tags {
	...
	public static String tagprev="";

	public String recentTag(String tid,String access_token)
	{
		String result="";
		try
		{
//			System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@ https://api.instagram.com/v1/tags/"+tid+"/media/recent?count=1&access_token="+access_token);
			HttpGet hget=new HttpGet("https://api.instagram.com/v1/tags/"+tid+"/media/recent?count=1&access_token="+access_token);
		    	...
		    	BufferedReader in = new BufferedReader(new
		    			...
		    			for(int i=0;i<jdata.length();i++)
		    			{
		    				if(jdata.getJSONObject(i).getString("type").equals("image"))
		    				{
		    					...
		    					if(media_id.equals(Tags.tagprev))
		    					{
		    						return "dup";
		    					}
		    					Tags.tagprev=media_id;
...
//		    					}
//		    					System.out.println("Checkkkkkkkkkkkkkkkkkkkkk");
