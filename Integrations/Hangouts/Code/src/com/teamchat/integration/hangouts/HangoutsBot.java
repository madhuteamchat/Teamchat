...
public class HangoutsBot {
	...
	public void help(TeamchatAPI api) {
		...
		String url = configProps.getProperty("server") + "Hangouts.jsp";
		//url = TeamchatEmbeddLink.createEmbeddedLink(configProps.getProperty("server") + "Hangouts.jsp", "Start Hangouts", "http");
		api.perform(api
				.context()
				.currentRoom()
	...
	public void hangout (TeamchatAPI api) {
		...
		//link = TeamchatEmbeddLink.createEmbeddedLink(link, "Hangouts", "http");
