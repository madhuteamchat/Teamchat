...
// Youtube Connect
		...
		public void connectYoutube(TeamchatAPI api) {
			...
			if(gc[1].equals("refresh_token"))
			{
				...
				String url="http://interns.teamchat.com:8080/YouTubeIntegration/YoutubeBotServelet?rid="+rid+"&client_id="+client_id+"&client_secret="+client_secret+"&name="+sname;
...
//							));	
					TeamchatURLlink urlLink = new TeamchatURLlink();
					String url="http://interns.teamchat.com:8080/YouTubeIntegration/index.html";
