...
public class roombot {
	...
	public void adduser(TeamchatAPI api) {
		...
		api.perform(roo.post(new PrimaryChatlet()
				.setQuestionHtml("<h4><b>Room Details:</b></h4>"
						...
						+ "<br /><a href=\"" + roomlink + "\"><b style=\"color:#359FD8\";>Go To Room</b></a>")));
	...
	public void help(TeamchatAPI api) {
		...
		//<br />Write a command <b>"Room"<> for extracting the link.<br /> After that just click on the image and it will redirect you to a page, Where you will find a Start video chat button click on that.
		
		// +
		// "<br /> After that just click on the image and it will redirect you to a page, Where you will find a Start video chat button click on that."
		// +
		// "<br />It will redirect you to a page Where you will find a link copy that link and paste it in the reply with the email id of the person you want to interact with.")));
