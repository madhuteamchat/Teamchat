...
import yammer.users.User;
import yammer.users.UserMethods;
...
public class YammerBot {
   ...
   public void initialize() {
		TeamchatAPIImpl.fromFile("teamchat.data")
		.setEmail("botteamchat@gmail.com")
		.setPassword("hellmasterbot")
		.startReceivingEvents(this);
		System.out.println("Started Yammer");
		try {
