package com.teamchat.integration.fullcontact.utils;
...
public class Utility {
	...
	public static final String rowWhite = "<tr style=''> <td style='background-color:White ; color:black; padding:3px 5px 3px 5px;'> <b>__aa</b> </td> <td style='background-color:White ; color:black; padding:3px 5px 3px 5px;'>__bb</td> </tr> ";
	public static final String rowSmoke = "<tr style=''> <td style='background-color:WhiteSmoke ; color:black; padding:3px 5px 3px 5px;'> <b>__aa</b> </td> <td style='background-color:WhiteSmoke ; color:black; padding:3px 5px 3px 5px;'>__bb</td> </tr> ";
