...
public class FullContactCard extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String show = "";
		String start = "<div style='box-shadow:0px 0px 3px DodgerBlue;'> ";
		String div = "<div align='center'><b style='color:grey; font-size:13px '>__aa</b></div>";
		String startTable = "<table width='100%' border='0px' bordercolor='DodgerBlue ' style='font-size:11px;border-collapse: collapse;'> <!--headrer --> ";
		// String head =
		// "<tr style=' border-top:5px; border-top-color:DodgerBlue; border-top-style:solid;border-bottom:5px; border-bottom-color:DodgerBlue; border-bottom-style:solid'> <td width='25%' style='background-color:DodgerBlue ; color:white; padding:0px 5px 0px 5px; border-right:thin white solid;'>__aa</td> <td width='25%' style='background-color:DodgerBlue ; color:white; padding:0px 5px 0px 5px;'>__bb</td> </tr>";
		String rowWhite = "<tr style=''> <td style='background-color:White ; color:black; padding:3px 5px 3px 5px;'> <b>__aa</b> </td> <td style='background-color:White ; color:black; padding:3px 5px 3px 5px;'>__bb</td> </tr> ";
		String rowSmoke = "<tr style=''> <td style='background-color:WhiteSmoke ; color:black; padding:3px 5px 3px 5px;'> <b>__aa</b> </td> <td style='background-color:WhiteSmoke ; color:black; padding:3px 5px 3px 5px;'>__bb</td> </tr> ";
