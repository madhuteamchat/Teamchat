...
public class BoxBot {
	...
	public void box (TeamchatAPI api) {
		...
		//String urls = createEmbeddedLink(url, "Select", "http");
		
		api.perform(api
				.context()
				.currentRoom()
				.post(new PrimaryChatlet().setQuestionHtml(""
						//+ "<a href='" + urls + "' target=_blank>Share</a> (opens in teamchat)"
						//+ "<div align=center><b>or</b></div>"
						+ "Click <a href='" + url + "' target=_blank>here</a> to select and share files or folders"
								+ "<br/><div align=center><b>Supports web only</b></div>")));
	}
